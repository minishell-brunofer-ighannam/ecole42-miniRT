...
/*   Updated: 2026/02/09 00:57:34 by bruno-valer      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline double	ft_cone_baskara(double a, double half_b, double c);
...
static double	ft_colision_cone_body(t_ray ray, t_cone *cone)
{
	...
	cos_alpha_sqrd = sqrdd(cos(cone->half_apex_angle));
